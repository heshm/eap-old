...
$(function() {
	js.initTabPage("tabpanel",
			{
				height : function() {
					var g = $(window).height(), e = $(".main-header:visible")
							.outerHeight(), f = $(".main-footer:visible")
							.outerHeight(), d = g - e - f;
					return d < 300 ? 300 : d
				}
			});
	...
	if (b.size() > 0) {
		...
		if (a != "" && a != ctx) {
			js.addTabPage(null,
					'<i class="fa fa-home"></i> ' + b.data("title"), a, false,
					false)
		}
	}
			...
			function() {
				js.layer.open({
					...
					success : function(d, e) {
						if ($(js.layer.window).width() < 500
								|| $(js.layer.window).height() < 390) {
							js.layer.full(e)
						}
					},
				})
