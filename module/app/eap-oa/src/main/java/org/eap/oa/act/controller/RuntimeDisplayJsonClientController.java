...
import org.eap.framework.web.service.exception.BadRequestException;
import org.eap.framework.web.service.exception.InternalServerErrorException;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ArrayNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import org.eap.oa.act.editor.mapper.EventInfoMapper;
import org.eap.oa.act.editor.mapper.InfoMapper;
import org.eap.oa.act.editor.mapper.ReceiveTaskInfoMapper;
import org.eap.oa.act.editor.mapper.SequenceFlowInfoMapper;
import org.eap.oa.act.editor.mapper.ServiceTaskInfoMapper;
import org.eap.oa.act.editor.mapper.UserTaskInfoMapper;

@RestController
@RequestMapping(value = "/oa/act/app")
public class RuntimeDisplayJsonClientController extends BaseController {
	...
	public RuntimeDisplayJsonClientController() {
	...
	public JsonNode getModelJSON(@PathVariable String processInstanceId) {
		...
		if (pojoModel == null || pojoModel.getLocationMap().isEmpty()) {
			throw new InternalServerErrorException(
					"Process definition could not be found with id " + processInstance.getProcessDefinitionId());
		}
	...
	private List<String> gatherCompletedFlows(Set<String> completedActivityInstances,
		...
		// TODO: not a robust way of checking when parallel paths are active, should be
		// revisited
		// Go over all activities and check if it's possible to match any outgoing paths
